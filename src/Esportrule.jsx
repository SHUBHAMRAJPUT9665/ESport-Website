...
const Esportrule = () => {
  const openPdf = () => {
    const pdfPath = 'BGIM Website\public\BGMI ForgeArena 2k24.pdf';
  ...
  return (
    <div className="flex flex-col md:flex-row bg-black text-white p-8 rounded-lg shadow-lg">
      ...
      <div className="md:w-2/3">
        ...
        <button onClick={openPdf} className="mt-4 flex items-center justify-center px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-lg">
